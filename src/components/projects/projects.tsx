...
export default function Projects (){
    ...
    return (
        <div id="projects" className="w-full md:border-b-2 md:border-letterColor md:border-b-letterColor flex flex-col items-center justify-center p-5 md:p-10 gap-10">

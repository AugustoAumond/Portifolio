...
import './animationcsAbout.css';

export default function About(){
    return (
        <div id="about" className="w-full h-[unset] bg-slate-950 md:h-[700px] flex items-center justify-center mt-20 p-5 md:p-10 border-b-2 border-b-letterColor">
            <div className="w-full max-w-7xl h-full flex flex-col-reverse md:flex-row justify-evenly items-center gap-5">
                ...
                <div id="img-about" className="flex flex-col items-center justify-center gap-5 w-[50%]">
